...
void SetBlend(int blend)
{
	...
	{
		{ 0xFFFFFFFF, 0xFF80E0FF, 0xFFFFA080, 0xFF80FFA0, 0xFFA080FF },
		{ 0x00000000, 0x00003030, 0x00600000, 0x00006000, 0x00000060 },
		{ 0x80FFFFFF, 0x8080E0FF, 0x80FFA080, 0x8080FFA0, 0x80A080FF },
		{ 0x80FFFFFF, 0x8080E0FF, 0x80FFA080, 0x8080FFA0, 0x80A080FF },
		{ 0x40202020, 0x40102030, 0x40302010, 0x40103020, 0x40302010 }
	};
...
int WINAPI WinMain(HINSTANCE, HINSTANCE, LPSTR, int)
{
	...
	if(hge->System_Initiate())
	{
		...
		bgspr->SetColor(0xFF100000,2);
		bgspr->SetColor(0xFF100000,3);
